...
import 'package:biometric_attendance/face_mesh_painter.dart';
...
class _FaceMeshDetectorViewState extends State<FaceMeshDetectorView> {
  ...
  Future<void> _processImage(InputImage inputImage) async {
    ...
    if (inputImage.metadata?.size != null &&
      ...
      for (var element in meshes) {
        debugPrint('Face meshes contour: ${element.contours[FaceMeshContourType.faceOval]?.first.x}');
      }
      debugPrint('Face meshes found: ${meshes.length}');
      //debugPrint('Face meshes found: ${meshes.length}\n\n');
      setState(() {
        _text = meshes.length.toString();
